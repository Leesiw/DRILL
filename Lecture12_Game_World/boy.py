...
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER,\
    SHIFT_DOWN, SHIFT_UP, DASH_TIMER, SPACE, DEBUG_KEY = range(10)

event_name = ['RIGHT_DOWN', 'LEFT_DOWN', 'RIGHT_UP', 'LEFT_UP', 'SLEEP_TIMER',\
    'SHIFT_DOWN', 'SHIFT_UP', 'DASH_TIMER', 'SPACE']
...
next_state_table = {
    ...
    RunState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState, SHIFT_DOWN: DashState, SHIFT_UP: RunState,
               SPACE: RunState},
    SleepState: {LEFT_DOWN: RunState, RIGHT_DOWN: RunState, LEFT_UP: RunState, RIGHT_UP: RunState, SHIFT_DOWN: SleepState, SHIFT_UP: SleepState,
                 SPACE: IdleState}
}
